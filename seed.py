...
def seed_data():
    with app.app_context():
        ...
        # Add inventories
        inventories = [
            Inventory(make='Toyota', image='https://images.pexels.com/photos/3311574/pexels-photo-3311574.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', price=1500000, currency='USD', model='SUV', year='2022', VIN='12345678901234567', color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Available', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=1),
            Inventory(make='Honda', image='https://images.pexels.com/photos/712618/pexels-photo-712618.jpeg?auto=compress&cs=tinysrgb&w=600', price=7000000, currency='USD', model='Sedan', year='2021', VIN='98765432109876543', color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=2),
            Inventory(make='Mercedes Benz', image='https://images.pexels.com/photos/3786091/pexels-photo-3786091.jpeg?auto=compress&cs=tinysrgb&w=600', price=4000000, currency='USD', model='SUV', year='2022', VIN='98767898', color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Pending', cylinder=6, doors=4, stock_number=1001, purchase_cost=20000, profit=5000, user_id=3),
            Inventory(make='BMW', image='https://images.pexels.com/photos/2676096/pexels-photo-2676096.jpeg?auto=compress&cs=tinysrgb&w=600', price=5000000, currency='KSH', model='Sedan', year='2021', VIN='23456789', color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=2000, profit=700, user_id=2),
        ]
        ...
        # Add importations
        importations = [
            Importation(country_of_origin='Japan', transport_fee=1500, currency='USD', import_duty=30000, expense=50000, car_id=1),
            Importation(country_of_origin='Germany', transport_fee=2000, currency='USD', import_duty=40000, expense=70000, car_id=2),
            Importation(country_of_origin='USA', transport_fee=2500, currency='USD', import_duty=50000, expense=80000, car_id=3),
            Importation(country_of_origin='UK', transport_fee=1000, currency='USD', import_duty=20000, expense=30000, car_id=4),
        ]
        ...
        # Add sales
        sales = [
            Sale(inventory_id=1, customer_id=1, sale_date='2023-01-01', seller_id=4, status='Completed', history='First sale', discount=3000, promotions='None', commision=10000),
            Sale(inventory_id=2, customer_id=2, sale_date='2023-02-01', seller_id=5, status='Pending', history='Second sale', discount=5000, promotions='Holiday Sale', commision=5500),
            Sale(inventory_id=3, customer_id=3, sale_date='2023-03-01', seller_id=6, status='Refunded', history='Third sale', discount=2000, promotions='Spring Sale', commision=5000),
            Sale(inventory_id=4, customer_id=4, sale_date='2023-04-01', seller_id=4, status='Completed', history='Fourth sale', discount=1000, promotions='Clearance Sale', commision=7700),
        ]
        ...
        # Add invoices
        invoices = [
            Invoice(date_of_purchase='2023-01-02', method='Credit Card', amount_paid=1500000, fee=100, tax=100, currency='USD', seller_id=4, sale_id=1, balance=0, total_amount=1500000, installments=1, pending_cleared='Cleared', customer_id=1, vehicle_id=1, signature='John Doe', warranty='3 years', terms_and_conditions='Standard terms', agreement_details='Standard agreement', additional_accessories='None', notes_instructions='Handle with care', payment_proof='proof1.jpg'),
            Invoice(date_of_purchase='2023-02-02', method='Cash', amount_paid=2000000, fee=150, tax=150, currency='USD', seller_id=5, sale_id=2, balance=0, total_amount=20000, installments=1, pending_cleared='Cleared', customer_id=2, vehicle_id=2, signature='Jane Smith', warranty='2 years', terms_and_conditions='Standard terms', agreement_details='Standard agreement', additional_accessories='None', notes_instructions='Handle with care', payment_proof='proof2.jpg'),
            Invoice(date_of_purchase='2023-03-02', method='Bank Transfer', amount_paid=2500000, fee=200, tax=200, currency='USD', seller_id=6, sale_id=3, balance=0, total_amount=25000, installments=1, pending_cleared='Cleared', customer_id=3, vehicle_id=3, signature='Alice Johnson', warranty='5 years', terms_and_conditions='Standard terms', agreement_details='Standard agreement', additional_accessories='None', notes_instructions='Handle with care', payment_proof='proof3.jpg'),
            Invoice(date_of_purchase='2023-04-02', method='Credit Card', amount_paid=2700000, fee=50, tax=50, currency='KSH', seller_id=4, sale_id=4, balance=0, total_amount=2700, installments=1, pending_cleared='Cleared', customer_id=4, vehicle_id=4, signature='Bob Brown', warranty='1 year', terms_and_conditions='Standard terms', agreement_details='Standard agreement', additional_accessories='None', notes_instructions='Handle with care', payment_proof='proof4.jpg'),
        ]
