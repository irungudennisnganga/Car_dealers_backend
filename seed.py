...
def seed_data():
    with app.app_context():
        ...
        inventory3 = Inventory(make='Mercedez Benz', image='https://images.pexels.com/photos/3786091/pexels-photo-3786091.jpeg?auto=compress&cs=tinysrgb&w=600', price=25000, currency='USD', model='SUV', year='2022', VIN=98767898, color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Pending', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=3)
        inventory4 = Inventory(make='BMW', image='https://images.pexels.com/photos/2676096/pexels-photo-2676096.jpeg?auto=compress&cs=tinysrgb&w=600', price=2700000, currency='KSH', model='Sedan', year='2021', VIN=23456789, color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=2)
        
        inventory5 = Inventory(make='Mazda', image='https://images.pexels.com/photos/3166786/pexels-photo-3166786.jpeg?auto=compress&cs=tinysrgb&w=600', price=780, currency='USD', model='SUV', year='2022', VIN=876543459976, color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Pending', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=1)
        inventory6 = Inventory(make='Porche', image='https://images.pexels.com/photos/2920064/pexels-photo-2920064.jpeg?auto=compress&cs=tinysrgb&w=600', price=9000, currency='USD', model='Sedan', year='2021', VIN=3456789856899, color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=2)
        
        inventory7 = Inventory(make='Range Rover', image='https://images.pexels.com/photos/15253379/pexels-photo-15253379/free-photo-of-off-road-car-standing-on-a-snowed-side-road.jpeg?auto=compress&cs=tinysrgb&w=600', price=1500000, currency='KSH', model='SUV', year='2022', VIN=4567890654457994, color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Not Available', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=2)
        inventory8 = Inventory(make='Dorge Challanger', image='https://images.pexels.com/photos/733745/pexels-photo-733745.jpeg?auto=compress&cs=tinysrgb&w=600', price=1000, currency='USD', model='Sedan', year='2021', VIN=86458974333, color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=3)
        
        inventory9 = Inventory(make='Golf TSI', image='https://images.pexels.com/photos/1805053/pexels-photo-1805053.jpeg?auto=compress&cs=tinysrgb&w=600', price=4500000, currency='KSH', model='SUV', year='2022', VIN=9864211009765, color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Available', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=3)
        inventory10 = Inventory(make='Golf R', image='https://images.pexels.com/photos/1402787/pexels-photo-1402787.jpeg?auto=compress&cs=tinysrgb&w=600', price=4800000, currency='KSH', model='Sedan', year='2021', VIN=96211234567986445, color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Not Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=3)
