...
def seed_data():
    with app.app_context():
        ...
        inventory3 = Inventory(make='Toyota', image='https://images.pexels.com/photos/3311574/pexels-photo-3311574.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', price=25000, currency='USD', model='SUV', year='2022', VIN=98767898, color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Pending', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=3)
        inventory4 = Inventory(make='Honda', image='https://images.pexels.com/photos/712618/pexels-photo-712618.jpeg?auto=compress&cs=tinysrgb&w=600', price=2700000, currency='KSH', model='Sedan', year='2021', VIN=23456789, color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=2)
        
        inventory5 = Inventory(make='Toyota', image='https://images.pexels.com/photos/3311574/pexels-photo-3311574.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', price=780, currency='USD', model='SUV', year='2022', VIN=876543459976, color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Pending', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=1)
        inventory6 = Inventory(make='Honda', image='https://images.pexels.com/photos/712618/pexels-photo-712618.jpeg?auto=compress&cs=tinysrgb&w=600', price=9000, currency='USD', model='Sedan', year='2021', VIN=3456789856899, color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=2)
        
        inventory7 = Inventory(make='Toyota', image='https://images.pexels.com/photos/3311574/pexels-photo-3311574.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', price=1500000, currency='KSH', model='SUV', year='2022', VIN=4567890654457994, color='Black', mileage=5000, body_style='SUV', transmission='Automatic', fuel_type='Gasoline', engine_size='3.5L', drive_type='AWD', trim_level='XLE', condition='New', availability='Not Available', cylinder=6, doors=4, stock_number=1001, purchase_cost=12000, profit=3000, user_id=2)
        inventory8 = Inventory(make='Honda', image='https://images.pexels.com/photos/712618/pexels-photo-712618.jpeg?auto=compress&cs=tinysrgb&w=600', price=1000, currency='USD', model='Sedan', year='2021', VIN=86458974333, color='White', mileage=10000, body_style='Sedan', transmission='Automatic', fuel_type='Gasoline', engine_size='2.0L', drive_type='FWD', trim_level='Touring', condition='Used', availability='Available', cylinder=4, doors=4, stock_number=1002, purchase_cost=15000, profit=5000, user_id=3)
        ...
        receipt3 = Receipt(user_id=3, customer_id=3, invoice_id=3, amount_paid=18500, commission=700)
        receipt4 = Receipt(user_id=4, customer_id=4, invoice_id=4, amount_paid=18500, commission=700)
        receipt5 = Receipt(user_id=5, customer_id=5, invoice_id=5, amount_paid=18500, commission=700)
        receipt6 = Receipt(user_id=6, customer_id=6, invoice_id=6, amount_paid=18500, commission=700)
        receipt7 = Receipt(user_id=7, customer_id=7, invoice_id=7, amount_paid=18500, commission=700)
        receipt8= Receipt(user_id=8, customer_id=8, invoice_id=8, amount_paid=18500, commission=700)
